...
contract TestRedeemScript is Script , StdCheats{
    ...
    address constant callerAddress = 0x429796dAc057E7C15724196367007F1e9Cff82F9;
    ...
    function run() public {
        ...
        console2.log("DEPLOYING NEW VAULT...");
        ...
        //// TEST STARTS HERE
        console2.log("IMPERSONATING LIVE VAULT WITH NEW VAULT...");
        //deal(USDCE_BASE, callerAddress, "100_000_000");
        vm.startPrank(callerAddress);
        ...
        IMetaVault.VaultDetailedData[] memory allVaults = vault2.getAllVaultsDetailedData();
